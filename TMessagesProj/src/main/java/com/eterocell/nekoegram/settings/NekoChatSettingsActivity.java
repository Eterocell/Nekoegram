            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == stickerSizeRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("MarkdownParser", R.string.MarkdownParser), NekoConfig.newMarkdownParser ? "Nekoegram" : "Telegram", position + 1 != markdown2Row);
                    }
                    break;
                }
                case 3: {
